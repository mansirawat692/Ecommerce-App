...
import com.example.testing.admin.AdminHome;
import com.example.testing.seller.SellerCategoryActivity;
import com.example.testing.admin.Admin_Activity;
...
public class LoginActivity extends AppCompatActivity
{
    ...
    private TextView AdminLink, NotAdminLink,createadmin,forgot;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        forgot=findViewById(R.id.forget_password_link);
        ...
        NotAdminLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                createadmin.setVisibility(View.INVISIBLE);
